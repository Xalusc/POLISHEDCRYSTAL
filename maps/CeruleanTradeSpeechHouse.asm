CeruleanTradeSpeechHouse_MapScriptHeader:
	...
	pokemon_event  6,  2, POLIWRATH, SPRITEMOVEDATA_POKEMON, -1, -1, PAL_NPC_BLUE, CeruleanTradeSpeechHouseRhydonText, -1
	pokemon_event  5,  6, IVYSAUR, SPRITEMOVEDATA_POKEMON, -1, -1, PAL_NPC_TEAL, CeruleanTradeSpeechHouseZubatText, -1
